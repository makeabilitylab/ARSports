...
2. `wandb login` to log into your wandb account (need to get one first). Simply copy & paste your API key into the conda prompt (you might not see the string as the interface won't display it) and press enter.
